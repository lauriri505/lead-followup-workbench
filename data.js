  ...
  leads: [
    {
      ...
      operations: [
        ["今天 09:30", "线索准备", "线索已进入销售工作台，等待处理", "系统"]
      ],
      notes: [
    ...
    },
    {
      ...
      operations: [["今天 10:20", "跟进提交", "跟进结果：未接通（第1次）", "sales 001 Deng Yao"]],
    ...
    },
    {
      ...
      operations: [["今天 09:00", "状态更新", "线索下发超过72小时，系统更新为过期未跟进", "系统"]],
    ...
    },
    {
      ...
      operations: [["今天 10:05", "状态流转", "未跟进 · 正常等待跟进 → 跟进中 · 有金融购车意向", "系统"], ["今天 10:04", "跟进提交", "客户表示需要贷款购车，但还要确认首付金额", "sales 001 Deng Yao"]],
    ...
    },
    {
      ...
      operations: [["08-03 16:45", "状态流转", "跟进中 · 待确认购车方式 → 暂存 · 明确表示全款", "系统"], ["08-03 16:44", "跟进提交", "客户明确表示只考虑全款购买", "sales 001 Deng Yao"]],
    ...
    },
    {
      ...
      operations: [["08-03 13:35", "状态流转", "跟进中 · 待确认购车方式 → 暂存 · 表示要先试驾", "系统"], ["08-03 13:34", "跟进提交", "客户表示要先体验车辆再决定购车方式", "sales 001 Deng Yao"]],
    ...
    },
    {
      ...
      operations: [["昨天 18:55", "跟进提交", "跟进结果：要求稍后联系；用户约定今天17:30联系", "sales 001 Deng Yao"]],
    ...
    },
    {
      ...
      operations: [["昨天 17:42", "跟进提交", "跟进结果：未接通（第2次），累计未接通次数更新为2", "sales 001 Deng Yao"], ["昨天 11:18", "跟进提交", "跟进结果：未接通（第1次）", "sales 001 Deng Yao"]],
